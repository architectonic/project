...
tags: [agents, instructions, project, source-grounding, okf]
okf_version: "0.1"
status: draft
---
...
3. Classify the material as project doctrine, source grounding, decision, open question, handoff, template, example, or temporary context.
